...
text_mods2 <- text_mods2 %>%
    mutate(new_X = new_X + offset_X,
           ...
           new_X = case_when(
             ...
             Shale_play == "Arkoma Woodford" ~ new_X * 0.15,  #$ + pos
...
```{r modify_new_states_map, eval=FALSE}
