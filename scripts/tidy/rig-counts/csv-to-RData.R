...
## ----csv_read------------------------------------------------------------
f_csv <- list.files("~/R/oil/data/rig_counts", full.names = TRUE)


## ----tidy_state_split----------------------------------------------------
f_state <- grep("by State", f_csv, value = TRUE)
...
## ----save_state_split----------------------------------------------------
save(rc_state, file = "~/R/oil/data/rig_counts/rc_state.RData")
...
## ----save_og-------------------------------------------------------------
save(rc_og, file = "~/R/oil/data/rig_counts/rc_og.RData")
...
## ----save_basin----------------------------------------------------------
save(rc_basin, file = "~/R/oil/data/rig_counts/rc_basin.RData")
...
## ----save_master---------------------------------------------------------
save(rc_master, file = "~/R/oil/data/rig_counts/rc_master.RData")
write_csv(rc_master, "~/R/oil/data/rig_counts/rc_master.csv")
