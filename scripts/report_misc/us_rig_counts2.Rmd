...
ggsave("imgs/trajectories.png", pg, width = 736/100, height = 500/100, dpi = 100)
...
ggsave("imgs/trj_by_basin.png", p_rcm2_grob, width = 900 / 100, height = 500 / 100, dpi = 100)
ggsave("imgs/trj_lgnd.png", lgnd, width = 415 / 100, height = 65 / 100, dpi = 100)


trj_basins <- image_read("imgs/trj_by_basin.png") %>%
  image_crop("x425+0+75")

trj_lgnd <- image_read("imgs/trj_lgnd.png") %>%
...
trj_lgnd %>%
  ...
  image_write("imgs/trj_by_basin.png")
```
...
ggsave("imgs/trj_by_county.png", loc_plot,
       width = 978 / 100, height = 845/ 100,
       dpi = 100)

image_read("imgs/trj_by_county.png") %>%
  # image_crop("1140x+29") %>%
  image_annotate("Source: Baker Hughes",
  ...
  image_write("imgs/trj_by_county.png")
```
