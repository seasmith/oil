...
save("states_48", file = file.path(maps_path, "states_48.RData"))
save(states_map_adjusted_simp, file = "~/R/oil/data/maps/states_map_adjusted_simp.RData")

save("sf_plays",  file = file.path(maps_path, "sf_plays.RData"))
save("sf_plays",  file = "~/R/misc/maps/sf_plays.RData")

save("text_mods", file = file.path(maps_path, "text_mods.RData"))
save("line_barnett",       file = file.path(maps_path, "line_barnett.RData"))
save("line_cana_woodford", file = file.path(maps_path, "line_cana_woodford.RData"))

save("text_mods2",    file = file.path(maps_path, "text_mods2.RData"))
save("line_barnett2", file = file.path(maps_path, "line_barnett2.RData"))
save("line_cana_woodford2", file = file.path(maps_path, "line_cana_woodford2.RData"))
```
