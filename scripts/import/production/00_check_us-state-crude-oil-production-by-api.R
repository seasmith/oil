...
cat_2477496_meta <- res_child

# Find updated rows and update the 'updated' column
updated_rows <- cat_2477496_meta$updated != res_child$updated
cat_2477496_meta$updated[updated_rows] <- res_child$updated[updated_rows]
