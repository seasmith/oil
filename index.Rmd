...
load(file.path(maps_path, "text_mods2.RData"))
load(file.path(maps_path, "line_barnett.RData"))
load(file.path(maps_path, "line_cana_woodford.RData"))
load(file.path(maps_path, "line_barnett2.RData"))
load(file.path(maps_path, "line_cana_woodford2.RData"))
...
ggsave("rig_count_map.png", rc_gb_grob, dpi = 100)
```
...
ggsave("rig_count_timeline.png", rt_gb_grob, dpi = 100)
```
